...
class DepositController extends Controller
{
    ...
    public function history(Request $request)
    {
        ...
        $totalCharges = Transaction::whereIn('type', [TxnType::ManualDeposit->value, TxnType::Deposit->value])
        ...
        return view('backend.deposit.history', compact('deposits', 'totalCharges'));
    }
