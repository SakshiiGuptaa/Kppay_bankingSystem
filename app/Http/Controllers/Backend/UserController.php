...
{
    use NotifyTrait,ImageUpload,VirtualCard;
    ...
    public function edit($id)
    {
        ...
        if(request('tab') == 'paybacks'){
            ...
            $cards = CustomersVirtualCard::where('user_id', $id)->get();
        }
    ...
    public function statusUpdate($id, Request $request)
    {
        ...
        $validator = Validator::make($input, [
            ...
            'virtual_card_status' => 'required',
            'merchant_account_status' => 'required',
        ...
        $data = [
            ...
            'virtual_card_status' => $input['virtual_card_status'],
            'merchant_account_status' => $input['merchant_account_status'],
