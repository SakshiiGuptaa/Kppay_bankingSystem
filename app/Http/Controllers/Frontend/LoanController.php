...
class LoanController extends Controller
{
    ...
    public function subscribe(Request $request)
    {
        ...
        //Get plan per_installment installment_intervel total_installment
        
        $per_installment = $plan->per_installment;
        $installment_intervel = $plan->installment_intervel;
        ...
        $loan = Loan::create([
            ...
            'installment_rate'=>$per_installment,
            'installment_interval'=>$installment_intervel,
