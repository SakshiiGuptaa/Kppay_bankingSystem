    ...
    <div class="side-nav-inside">
        <ul class="side-nav-menu">
            ...
            <li class="side-nav-item {{ isActive('admin.virtual.cards') }}">
                <a href="{{ route('admin.virtual.cards') }}"><i data-lucide="credit-card"></i><span>{{ __('Virtual Cards') }}</span></a>
            </li>
            @endcan

            @can('merchant-account-list')
            <li class="side-nav-item {{ isActive('admin.merchant.accounts') }}">
                <a href="{{ route('admin.merchant.accounts') }}"><i data-lucide="credit-card"></i><span>{{ __('Merchant Accounts') }}</span></a>
            </li>
            @endcan
            
            @canany(['user-paybacks','bank-profit','master-account'])
            <li class="side-nav-item side-nav-dropdown {{ isActive(['admin.paybacks', 'admin.bank.profit','admin.master.account']) }}">
                ...
                <ul class="dropdown-items">
                    ...
                    @endcan
                    @can('master-account')
                    <li class="{{ isActive('admin.master.account') }}">
                        <a href="{{route('admin.master.account')}}">
                            <i data-lucide="credit-card"></i><span>{{ __('Master Account') }}</span>
                        </a>
                    </li>
                    @endcan
                </ul>
            ...
            <li class="side-nav-item side-nav-dropdown {{ isActive(['admin.others-bank*', 'admin.wire.transfer*', 'admin.fund.transfer*']) }}">
                ...
                <ul class="dropdown-items">
                    ...
                    <li class="side-nav-item {{ isActive('admin.fund.transfer.own.bank*') }}">
                        <a href="{{route('admin.fund.transfer.own.bank')}}"><i data-lucide="user-check"></i><span>{{ __('Own Bank Transfer') }}</span></a>
                    </li>
                    @endcan
