                        ...
                        <div class="site-card-body">
                            <form action="{{route('admin.plan.loan.update',$plan->id)}}" method="post"
                                ...
                                <div class="addOptions">
                                    @if($plan->field_options && json_decode($plan->field_options, true))
                                                ...
                                                <div class="option-remove-row row">
                                                    ...
                                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                                                        <div class="site-input-groups">
                                                            <select name="field_options[{{$key}}][type]" onchange="addOptions(this,'{{ $key }}')" class="form-select form-select-lg mb-3">
                                                                <option value="text" @selected(isset($value['type']) && $value['type'] == 'text')>{{ __('Text') }}</option>
                                                                <option value="textarea" @selected(isset($value['type']) && $value['type'] == 'textarea')>{{ __('Textarea') }}</option>
                                                                <option value="file" @selected(isset($value['type']) && $value['type'] == 'file')>{{ __('File upload') }}</option>
                                                                <option value="checkbox" @selected(isset($value['type']) && $value['type'] == 'checkbox')>{{ __('Checkbox') }}</option>
                                                                <option value="select" @selected(isset($value['type']) && $value['type'] == 'select')>{{ __('Select') }}</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                                                        <div class="site-input-groups mb-0">
                                                            <select name="field_options[{{ $key }}][validation]" class="form-select form-select-lg mb-1">
                                                                <option value="required" @selected(isset($value['validation']) && $value['validation'] == 'required')>{{ __('Required') }}</option>
                                                                <option value="nullable" @selected(isset($value['validation']) && $value['validation'] == 'nullable')>{{ __('Optional') }}</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="option-fields{{ $key }} row">
                                                        @if(isset($value['values']) && $value['values'] != null)
                                                            @foreach ($value['values'] as $serial => $fieldValue)
                                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 row" id="option-value-row">
                                                                    <div class="site-input-groups col-md-10">
                                                                        <input name="field_options_value[{{ $key }}][]" class="box-input" type="text" value="{{ $fieldValue }}" required placeholder="Enter Value">
                                                                    </div>
                                
                                                                    <div class="col-md-2" id="option-value-action">
                                                                        @if($loop->first)
                                                                            <button class="add-option-row me-2" onclick="addOptionValue('option-fields{{ $key }}','{{ $key }}')" type="button"> 
