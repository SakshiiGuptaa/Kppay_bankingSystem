                            ...
                            <div class="option-remove-row row">
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="site-input-groups">
                                        <input name="field_options[{{ $key }}][country_name]" class="box-input" type="text" value="{{ $currency->country_name }}" required placeholder="{{ __('Country Name') }}">
                                        <input name="field_options[{{ $key }}][current_country_name]" class="box-input" type="hidden" value="{{ $currency->country_name }}">
                                    </div>
                                </div>
            ...
            $("#generate").on('click', function () {
                ...
                var form = `<div>
                    <div class="option-remove-row row">
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="site-input-groups">
                                <input name="field_options[` + i + `][country_name]" class="box-input" type="text" value="" required placeholder="{{ __('Country Name') }}">
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="site-input-groups">
