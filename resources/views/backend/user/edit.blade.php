                        ...
                        <div class="top">
                            <div class="avatar">
                                <div class="avatar-face">
                                    @if(null != $user->avatar)
                                    <div class="avatar-face">
                                      <img class="avatar-img" src="{{asset($user->avatar)}}" alt="{{$user->full_name}}"/>
                                    </div>
                                    @else
                                        ...
                                        @if (setting('multiple_currency', 'permission'))
                                            ...
                                            <div class="admin-user-balance-card">
                                                ...
                                                <div class="wallet-info">
                                                    ...
                                                    <div
                                                        class="balance">{{ $wallet['symbol'] . $wallet['balance'] }}</div>
                                                </div>
                                            </div>
                                            @endforeach
                                        @else
                    ...
                    <div class="site-tab-bars">
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            ...
                            @if (setting('virtual_card', 'permission'))
                                ...
                                <li class="nav-item" role="presentation">
                                    <a
                                        href="{{ route('admin.user.edit',['user' => $user->id,'tab' => 'card']) }}"
                                        class="nav-link {{ request('tab') == 'card' ? 'active' : '' }}"
                                    ><i data-lucide="wallet"></i>{{ __('Virtual Card') }}</a>
                                </li>
                                @endcan
                            @endif
