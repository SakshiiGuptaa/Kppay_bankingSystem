    ...
    <div class="site-card-body">
        <div class="row">
            <form action="{{route('admin.user.status-update',$user->id)}}" method="post">
                ...
                <div class="col-xl-12">
                    <div class="profile-card-single">
                        <h5 class="heading">{{ __('Virtual Card Status') }}</h5>
                        <div class="switch-field">
                            <input
                                type="radio"
                                id="virtual_card_status-active"
                                name="virtual_card_status"
                                value="1"
                                @if($user->virtual_card_status) checked @endif
                            />
                            <label for="virtual_card_status-active">{{ __('Active') }}</label>
                            <input
                                type="radio"
                                id="virtual_card_status-disabled"
                                name="virtual_card_status"
                                value="0"
                                @if(!$user->virtual_card_status) checked @endif
                            />
                            <label for="virtual_card_status-disabled">{{ __('Disabled') }}</label>
                        </div>
                    </div>
                </div>
                <div class="col-xl-12">
                    <div class="profile-card-single">
                        <h5 class="heading">{{ __('Merchant Account Status') }}</h5>
                        <div class="switch-field">
                            <input
                                type="radio"
                                id="merchant_account_status-active"
                                name="merchant_account_status"
                                value="1"
                                @if($user->merchant_account_status) checked @endif
                            />
                            <label for="merchant_account_status-active">{{ __('Active') }}</label>
                            <input
                                type="radio"
                                id="merchant_account_status-disabled"
                                name="merchant_account_status"
                                value="0"
                                @if(!$user->merchant_account_status) checked @endif
                            />
                            <label for="merchant_account_status-disabled">{{ __('Disabled') }}</label>
                        </div>
                    </div>
                </div>                
                <div class="col-xl-12">
