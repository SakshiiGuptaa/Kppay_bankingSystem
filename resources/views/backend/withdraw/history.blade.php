    ...
    <div class="col-xl-12 col-md-12">
        <div class="site-card-body table-responsive">
            <div class="site-table table-responsive">
                <div class="card-header-info" style="display: inline-block; background: rgba(42, 157, 143, 0.25); border-radius: 15px; padding: 6px 16px; border: none; color: #2a9d8f; font-size: 14px; font-weight: 700; float: right; margin:15px;">Total Charges: {{ number_format($totalCharges, 2) }} XOF</div>
