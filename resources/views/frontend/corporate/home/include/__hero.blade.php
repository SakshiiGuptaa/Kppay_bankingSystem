       ...
       <div class="row gy-50 align-items-center">
                   ...
                   <ul>
                      <li>
                         <div class="list-item">
                            ...
                            <span class="list-title">Our platform is fast</span>
                         </div>
                         <div class="list-item">
                            <span class="list-icon"><img src="{{ asset('front/theme-2') }}/images/icons/check-white.svg" alt="check"></span>
                            <span class="list-title">We keep your data secure</span>
                         </div>
                         <div class="list-item">
                            <span class="list-icon"><img src="{{ asset('front/theme-2') }}/images/icons/check-white.svg" alt="check"></span>
                            <span class="list-title">Enjoy hassle-free use</span>
                         </div>
                      </li>
                   </ul>
                </div>
          ...
          <div class="col-xxl-6 col-xl-6 col-lg-6">
            <div class="banner-illustration">
               <div class="thumb">
                  <img src="{{ asset($data['hero_right_down_img']) }}" alt="illustration">
               </div>
              ...
              <div class="user-one">
                  <img src="{{ asset($data['hero_right_img']) }}" alt="user-01">
              </div>
              <div class="user-two">
