                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                    <div class="single-spec-stat">
                        ...
                        <div class="text">
                            ...
                            <p>{{ _('DPS will be end by') }} <strong>{{ $dps_last_date }}</strong> {{ _('and fund will be added on your account.') }}</p>
                            @else
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                    <div class="single-spec-stat">
                        ...
                        <div class="text">
                            ...
                            <p>{{ _('FDR will be end by ') }}<strong>{{ $fdr_last_date }}</strong>{{ _(' and fund will be added on your account.') }}</p>
                            @else
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                    <div class="single-spec-stat">
                        ...
                        <div class="text">
                            ...
                            <p>{{ _('Your Loan will be closed on') }} <strong>{{ $loan_last_date }}</strong>, {{ _('Need to payback continuously.') }}</p>
                            @else
