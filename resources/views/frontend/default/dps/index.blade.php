                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                                <div class="plan-card-box">
                                    ...
                                    <a href=""
                                       ...
                                       data-cancel-fee="{{ $plan->cancel_fee_type == 'fixed' ? $plan->cancel_fee.' '.$currency : $plan->cancel_fee.'%' }}"
                                ...
                                <div class="modal-body popup-body">
                                    ...
                                    <div class="popup-body-text">
                                        ...
                                        <form id="applyForm" method="POST" action="">
                                            ...
                                            <button type="submit" class="site-btn-sm polis-btn me-2 w-100">
                                                <i data-lucide="check"></i>
                                                {{ __('Subscribe Now') }}
                                            </button>
                                        </form>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.subscribeBtn', function (e) {
                ...
                $('#applyForm').attr('action', url); // Set form action dynamically
                $('#plan-id').val(id); // Set hidden input value
            });
