                        ...
                        <div class="step-details-form mb-4">
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="inputs">
                                        <label for="" class="input-label">{{ __('From') }}<span class="required">*</span></label>
                                        <select name="from" class="box-input" id="fromOption">
                                            <option value="" disabled selected>--{{ __('Select From') }}--</option>
                                            <option value="wallet">{{ __('Wallet') }}</option>
                                            <option value="virtual_card">{{ __('Virtual Card') }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="inputs">
                                        <label for="" class="input-label">{{ __('Select Account') }}<span class="required">*</span></label>
                                    ...
                                    <div class="inputs">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-text">
                                                {{ $code == 'default' ? setting('site_currency', 'global') : $code }}
                                            </span>
                                        </div>
