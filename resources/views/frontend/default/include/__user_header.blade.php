                    ...
                    <div class="nav-right">
                        ...
                        <div class="single-right mob-650-none">
                            <div class="help-support">
                                <a href="{{ route('user.ticket.index') }}" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip" data-bs-placement="top" data-bs-title="Help and Support"><i style="color:#5dcbff;" data-lucide="help-circle"></i></a>
                            </div>
                        </div>
                        <div class="single-right">
