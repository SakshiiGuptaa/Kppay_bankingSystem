    ...
    <nav class="user-nav">
        <ul>
            @foreach ($navigations as $navigation)
                @if ($navigation->type == 'cards' && setting('virtual_card', 'permission') && auth()->user()->virtual_card_status)
                ...
                @elseif ($navigation->type == 'loan' && setting('user_loan', 'permission') && auth()->user()->loan_status)
                    @include('frontend::include.__menu-item',['navigation' => $navigation])                
                @elseif ($navigation->type == 'merchant_account' && setting('merchant_account', 'permission') && auth()->user()->merchant_account_status)
                    @include('frontend::include.__menu-item',['navigation' => $navigation])
