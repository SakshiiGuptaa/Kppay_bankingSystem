                                ...
                                @foreach(json_decode($plan->field_options, true) as $key => $value)
                                    ...
                                    <div class="inputs">
                                        ...
                                        <div class="wrap-custom-file">
                                            <input type="file" name="submitted_data[{{ data_get($value, 'name') }}]" id="{{ data_get($value, 'name') }}"/>
                                    ...
                                    <div class="inputs">
                                        ...
                                        <textarea name="submitted_data[{{ data_get($value, 'name') }}]" cols="10" rows="5" class="box-textarea" @required(data_get($value, 'validation') == 'required')></textarea>
                                    </div>
                                    @endif
                                @endforeach
                            @endif
