                    ...
                    <div class="site-custom-table site-custom-table-sm">
                        <div class="contents">
                            ...
                            <div class="site-table-list">
                                ...
                                <div class="site-table-col">
                                    <div class="fw-bold">{{ ($loan->amount / 100 ) * $loan->installment_rate .' '. $currency }} (Every {{ $loan->installment_interval }} Days)</div>
                                </div>
                            </div>
                            <div class="site-table-list">
                                <div class="site-table-col">
                                ...
                                <div class="site-table-col">
                                    <div class="fw-bold">{{ $loan->total_installments }} Times</div>
                                </div>
                            </div>
                            <div class="site-table-list">
                                <div class="site-table-col">
