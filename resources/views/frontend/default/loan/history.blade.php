                            ...
                            @foreach($loans as $loan)
                                <div class="site-table-list">
                                    ...
                                    <div class="site-table-col">
                                        <div class="description">
                                            <div class="content">
                                                <div class="title">{{ ($loan->amount / 100 ) * $loan->installment_rate }} {{ $currency }}</div>
                                                <div class="date">Every {{ $loan->installment_interval }} Days</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="site-table-col">
                                    ...
                                    <div class="site-table-col">
                                        <div class="description">
                                            <div class="content">
                                                <div class="title">{{ $loan->total_installments }}</div>
