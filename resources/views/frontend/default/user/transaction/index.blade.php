                        ...
                        <div class="site-table-list">
                            ...
                            <div class="site-table-col">
                                <div class="action">
                                    ...
                                    data-amount="{{ isPlusTransaction($transaction->type) == true ? '+' : '-' }}{{ $transaction->amount.' '.$transaction->pay_currency }}"
                                    data-charge="{{ $transaction->charge.' '.$transaction->pay_currency  }}"
                            ...
                            <div class="modal-body popup-body">
                                ...
                                <div class="popup-body-text">
                                    ...
                                    <div class="modal-beneficiary-details">
                                        ...
                                        <!--<div class="profile-text-data">-->
                                        <!--    <div class="attribute">{{ __('Total(USD)') }}</div>-->
                                        <!--    <div class="value totalusd-value"></div>-->
                                        <!--</div>-->
                                        <div class="profile-text-data">
...
<script>
    ...
    $(document).on('click', '.details-btn', function (e) {
        ...
        // var totalusd = $(this).data('totalusd');
