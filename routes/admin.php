...
use App\Http\Controllers\Backend\MasterAccountController;
...
use App\Http\Controllers\Backend\MerchantAccountController;
...
Route::group(['prefix' => 'loan', 'as' => 'loan.', 'controller' => LoanController::class], function () {
    ...
    Route::post('/update/{loan_id}', 'updateStore')->name('updatestore');
});
...
Route::get('master-account', [MasterAccountController::class, 'masterAccount'])->name('master.account');


//===============================  Merchant Account ==================================
Route::get('merchant-accounts', [MerchantAccountController::class, 'index'])->name('merchant.accounts');
