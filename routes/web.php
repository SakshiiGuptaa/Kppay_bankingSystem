...
use App\Http\Controllers\Frontend\MerchantAccountController;
use App\Http\Controllers\Frontend\CustomersVirtualCardController;
...
Route::group(['middleware' => ['auth', '2fa', 'isActive', setting('otp_verification', 'permission') ? 'otp' : 'web', setting('email_verification', 'permission') ? 'verified' : 'web'], 'prefix' => 'user', 'as' => 'user.'], function () {
    ...
    Route::post('/user/virtual_card/store', [CustomersVirtualCardController::class, 'store'])->name('virtual_card.store');
    ...
    Route::controller(WalletController::class)->group(function () {
        ...
        Route::post('wallets/default', 'default')->name('wallets.default');
    ...
    Route::group(['prefix' => 'deposit', 'as' => 'deposit.'], function () {
        ...
        Route::post('status', [DepositController::class, 'checkTransactionStatus'])->name('status');
        Route::get('success', [DepositController::class, 'depositSuccess'])->name('success');
        Route::get('failed', [DepositController::class, 'depositFailed'])->name('failed');
    ...
    // Merchant Account
    Route::group(['prefix' => 'merchant-account', 'as' => 'merchant_account.'], function () {
        Route::get('/', [MerchantAccountController::class, 'index'])->name('index');
        Route::post('/store', [MerchantAccountController::class, 'store'])->name('store');

        Route::get('/product', [MerchantAccountController::class, 'products'])->name('product');
        
        Route::post('/product/store', [MerchantAccountController::class, 'productstore'])->name('product.store');
        Route::put('/product/update', [MerchantAccountController::class, 'update'])->name('product.update');

        
        Route::get('/features', [MerchantAccountController::class, 'features'])->name('features');
        Route::post('/feature/store', [MerchantAccountController::class, 'featureStore'])->name('feature.store');
        
        Route::get('/coupons', [MerchantAccountController::class, 'coupons'])->name('coupons');
        Route::post('/coupon/store', [MerchantAccountController::class, 'couponStore'])->name('coupon.store');
        
        Route::get('/shipping/rates', [MerchantAccountController::class, 'shippingRates'])->name('shipping.rates');
        Route::post('/shipping/store', [MerchantAccountController::class, 'shippingStore'])->name('shipping.store');
        
        Route::get('/tax/rates', [MerchantAccountController::class, 'taxRates'])->name('tax.rates');
        Route::post('/tax/store', [MerchantAccountController::class, 'taxStore'])->name('taxrate.store');
        
        Route::get('/pricing/table', [MerchantAccountController::class, 'pricingTable'])->name('pricing.table');
        Route::post('/pricing/store', [MerchantAccountController::class, 'pricingTableStore'])->name('pricing.store');
        
        Route::get('/subscribe/{id}', [MerchantAccountController::class, 'subscribe'])->middleware('passcode:dps')->name('subscribe');
        Route::get('/history', [MerchantAccountController::class, 'history'])->name('history');
        Route::get('/details/{id}', [MerchantAccountController::class, 'details'])->name('details');
        Route::get('/cancel/{id}', [MerchantAccountController::class, 'cancel'])->name('cancel');
        Route::post('/increment/{id}', [MerchantAccountController::class, 'increment'])->name('increment');
        Route::post('/decrement/{id}', [MerchantAccountController::class, 'decrement'])->name('decrement');
    });
    ...
    Route::group(['prefix' => 'dps', 'as' => 'dps.'], function () {
        ...
        Route::post('/subscribe/{id}', [DpsController::class, 'subscribe'])->middleware('passcode:dps')->name('subscribe');
